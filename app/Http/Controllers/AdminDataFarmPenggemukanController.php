<?php namespace App\Http\Controllers;
	...
	class AdminDataFarmPenggemukanController extends \crocodicstudio\crudbooster\controllers\CBController {
...
// 			$this->form[] = ['label'=>'Kode','name'=>'kode','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Jenis Pemeliharaan','readonly'=>true,'value'=>'penggemukan','name'=>'kode','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
...
// 			$this->form[] = ['label'=>'Pemilik ternak','name'=>'id_users','type'=>'select2','width'=>'col-sm-10','datatable'=>'cms_users,name'];
	        ...
	        */
	        $this->index_statistic = array();
	          $this->index_statistic[] = ['label'=>'Jumlah Ternak Penggemukan','count'=>DB::table('data_farm')
	         ->where('jenis_pemeliharaan','penggemukan')
  ...
  Ini adalah menu khusus untuk jenis pemelihaan penggemukan.
</div>';
	        ...
	        */
	        ...
	        $this->sub_module[] = ['label'=>'ADg Ternak','path'=>'adg_ternak','parent_columns'=>'kode,nama','foreign_key'=>'id_kambing','button_color'=>'success','button_icon'=>'fa fa-bars'];
