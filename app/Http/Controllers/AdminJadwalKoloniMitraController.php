<?php namespace App\Http\Controllers;
	...
	class AdminJadwalKoloniMitraController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "jadwal_koloni_mitra";
			...
			$this->col[] = ["label"=>"Tgl Masuk","name"=>"tgl_masuk"];
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','width'=>'col-sm-10','dataenum'=>'proses koloni;selesai koloni'];
			...
			//$this->form[] = ["label"=>"Tgl Keluar","name"=>"tgl_keluar","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
	        ...
	        */
	        $this->pre_index_html = null;
	        	        	        ...
	        	        	        $this->pre_index_html = '<div class="alert alert-warning" role="alert">
  Ini adalah menu mitra atau karyawan yang bisa mengelolanya, silahkan login sebgai mitra untuk mengelola halaman ini. <br> Silahkan isi jadwal kawain koloni ternak anda. 
</div>';
