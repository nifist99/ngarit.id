<?php namespace App\Http\Controllers;
	...
	class AdminJadwalFarmInvestorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "jadwal_farm_investor";
			...
			$this->form[] = ['label'=>'Jadwal','name'=>'jadwal','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10','datatable'=>'data_farm_investor,nama'];
