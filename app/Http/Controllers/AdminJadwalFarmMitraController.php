<?php namespace App\Http\Controllers;
	...
	class AdminJadwalFarmMitraController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kondisi Pelaksanaan","name"=>"kondisi_pelaksanaan"];
			...
			$this->form[] = ['label'=>'Jadwal','name'=>'jadwal','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10','datatable'=>'jadwal_farm_mitra,nama'];
			$this->form[] = ['label'=>'Kondisi Pelaksanaan','name'=>'kondisi_pelaksanaan','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
