<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsersMitraController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Created By','name'=>'id_created_by','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'created_by,id'];
	        ...
	        */
	        ...
	        $this->sub_module[] = ['label'=>'Data Ternak Di Mitra','path'=>'data_farm','parent_columns'=>'name','foreign_key'=>'id_mitra','button_color'=>'success','button_icon'=>'fa fa-bars'];
	        
	        $this->sub_module[] = ['label'=>'Pengeluaran Mitra','path'=>'pengeluaran_farm_mitra','parent_columns'=>'name','foreign_key'=>'id_users','button_color'=>'success','button_icon'=>'fa fa-bars'];
	        
	        $this->sub_module[] = ['label'=>'Pemasukan Mitra','path'=>'pemasukan_farm_mitra','parent_columns'=>'name','foreign_key'=>'id_users','button_color'=>'success','button_icon'=>'fa fa-bars'];
