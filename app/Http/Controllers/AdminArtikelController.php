<?php namespace App\Http\Controllers;
	...
	class AdminArtikelController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kategori","name"=>"id_kategori","join"=>"kategori_artikel,nama"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Judul','name'=>'judul','type'=>'text','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Content','name'=>'content','type'=>'wysiwyg','validation'=>'required|string|min:5|max:500000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kategori','name'=>'id_kategori','type'=>'select2','validation'=>'required','width'=>'col-sm-9','datatable'=>'kategori_artikel,nama','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			...
			$this->form[] = ['label'=>'Tgl','name'=>'tgl','type'=>'datetime','validation'=>'required|date','width'=>'col-sm-10'];
	        ...
	        */
	        $this->script_js = NULL;
	          ...
	          $this->script_js="
				function publish(id){
			        swal({
			            title: 'Apakah artikel ini mau di publish ?',
			            type:'info',
			    ...
			    function unpublish(id){
			        swal({
			            title: 'Apakah artikel ini tidak di publish ?',
			            type:'info',
			            showCancelButton:true,
			            allowOutsideClick:true,
			            confirmButtonColor: '#DD6B55',
	    ...
	    */
	    ...
	    public function getPublish($id){
	    	...
	    	$cek=DB::table('artikel')->where('id',$id)->update($status);
