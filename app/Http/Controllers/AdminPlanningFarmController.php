<?php namespace App\Http\Controllers;
	...
	class AdminPlanningFarmController extends \crocodicstudio\crudbooster\controllers\CBController {
...
$this->col[] = ["label"=>"Created By","name"=>"id_users","join"=>"cms_users,name"];
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10','dataenum'=>'terlaksana;belum terlaksana'];
  ...
  Silahkan isi rencana kedepan peternakan anda, ini seperti menu note atau catatan.
</div>';
	    ...
	    */
	    public function hook_after_delete($id) {
	      ...
	      public function getApprove($id){
	    	...
	    	$status['status']="terlaksana";

	    	$cek=DB::table('planning_farm')->where('id',$id)->update($status);
	    	...
	    	$status['status']="belum terlaksana";
