<?php namespace App\Http\Controllers;
	...
	class AdminFaqFarmController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'wysiwyg','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tgl','name'=>'tgl','type'=>'date','width'=>'col-sm-10'];
 ...
 Ini adalah contoh MOU untuk mitra, investor atau peternak silahkan bisa di download sebagai tanda kerja sama. atau dapat bikin sendiri.
</div>';
