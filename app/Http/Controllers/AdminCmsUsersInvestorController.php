<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsersInvestorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Cms Privileges','name'=>'id_cms_privileges','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','help'=>'Minimum 5 characters. Please leave empty if you did not change the password.'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'cms_privileges,name'];
			...
			//$this->form[] = ["label"=>"Farm","name"=>"farm","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			...
			//$this->form[] = ["label"=>"Ktp","name"=>"ktp","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
	        ...
	        */
	        $this->index_button = array();
	         ...
	         $this->sub_module[] = ['label'=>'Data Ternak Investor','path'=>'data_farm_investor','parent_columns'=>'name','foreign_key'=>'id_investor','button_color'=>'success','button_icon'=>'fa fa-bars'];
	        
	        $this->sub_module[] = ['label'=>'Pengeluaran Investor','path'=>'pengeluaran_farm_investor','parent_columns'=>'name','foreign_key'=>'id_users','button_color'=>'success','button_icon'=>'fa fa-bars'];
	        
	        $this->sub_module[] = ['label'=>'Pemasukan Investor','path'=>'pemasukan_farm_investor','parent_columns'=>'name','foreign_key'=>'id_users','button_color'=>'success','button_icon'=>'fa fa-bars'];
