<?php namespace App\Http\Controllers;
	...
	class AdminDataFarmPerahController extends \crocodicstudio\crudbooster\controllers\CBController {
...
// 			$this->form[] = ['label'=>'Kode','name'=>'kode','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Jenis Pemeliharaan','readonly'=>true,'value'=>'perah','name'=>'kode','type'=>'text','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
...
// 			$this->form[] = ['label'=>'Pemilik ternak','name'=>'id_users','type'=>'select2','width'=>'col-sm-10','datatable'=>'cms_users,name'];
	        ...
	        */
	        $this->index_statistic = array();
	          $this->index_statistic[] = ['label'=>'Jumlah Ternak Perah','count'=>DB::table('data_farm')
	         ->where('jenis_pemeliharaan','perah')
  ...
  Ini adalah menu khusus untuk jenis pemeliharaan perah
</div>';
