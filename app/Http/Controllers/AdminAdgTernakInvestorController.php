<?php namespace App\Http\Controllers;
	...
	class AdminAdgTernakInvestorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "adg_ternak_investor";
			...
			$this->form[] = ['label'=>'Tgl','name'=>'tgl','type'=>'date','validation'=>'required|date','width'=>'col-sm-10','datatable'=>'data_farm_investor,nama'];
