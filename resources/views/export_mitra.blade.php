...
<div class="information">
	...
	<div class="page">
      <table id="customers" class="table" border="1px">
        <tbody>
                 <tr>
               <?php $link = url('detail_ternak_mitra/'.$row[0]->kode); ?>
        ...
        $kesehatan=DB::table('kesehatan_ternak_mitra')->where('id_kambing',$row[0]->id)->get();
        $adg=DB::table('adg_ternak_mitra')->where('id_kambing',$row[0]->id)->get();
        $jadwal=DB::table('jadwal_farm_mitra')->where('id_kambing',$row[0]->id)->get();
        $susu=DB::table('susu_ternak_mitra')->where('id_ternak',$row[0]->id)->get();
